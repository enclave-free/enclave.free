...
import {
  ...
  type AdminSessionValidationState,
} from '../../utils/adminApi';

const AdminConfigAssistant = lazy(() =>
  import('../admin/AdminConfigAssistant').then((module) => ({
      ...
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-text-muted text-sm">
            {t(
              'adminRoute.extracted.verifying_admin_session_87c53b',
      ...
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="card max-w-md w-full space-y-4">
          <h1 className="text-lg font-semibold text-text">
            {t(
              'adminRoute.extracted.unable_to_verify_admin_session_5f87b8',
              'Unable to verify admin session'
            )}
          </h1>
          <p className="text-sm text-text-muted">
            {t(
              'adminRoute.extracted.the_backend_returned_an_error_while_validating_authentication_0a9a16',
