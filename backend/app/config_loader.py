...
logger = logging.getLogger("enclave.config_loader")
...
def get_smtp_config() -> dict:
    ...
    return {
        ...
        "from_address": _normalize_nonsecret_str(get_config("SMTP_FROM", "Enclave <noreply@localhost>")),
