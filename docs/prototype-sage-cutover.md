...
- Submodule provenance: `runtime/sage` is pinned to commit `16a48af96ea0df8bc3d843227a90410d7dc25e3d` from `https://github.com/enclave-free/sage.git`.
...
- Reproducible verification:
  ...
  2. `cd runtime/sage && git rev-parse HEAD` should print `16a48af96ea0df8bc3d843227a90410d7dc25e3d`.
