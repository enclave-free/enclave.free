...
- Submodule provenance: `runtime/sage` is pinned to commit `34d670babbfe49f2af51fcd1b656a9ae87400bff` from `https://github.com/enclave-free/sage.git`.
...
- Reproducible verification:
  ...
  2. `cd runtime/sage && git rev-parse HEAD` should print `34d670babbfe49f2af51fcd1b656a9ae87400bff`.
