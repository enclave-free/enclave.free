...
- Each request asks for aggregate provider usage when the protocol supports it. Returned counts become Model Usage Observations under ADR-0024; unsupported or omitted fields do not fail the turn.
