...
Audience: Enclave instance administrator
...
- Encrypted PII in Enclave requires the admin private key (Nostr `nsec`) for decryption.
...
3. SQLite data volume (`enclave.db`)
...
2. Authenticate as admin in Enclave.
