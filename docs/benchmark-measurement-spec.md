...
- Missing review is `unreviewed`; unavailable/invalid judge output is an evaluation error, never a quality pass.
...
- Use human-readable structured review files by default, with optional Tinfoil judge support subject to user preference. No automatic OpenAI grading or third-party transfer of benchmark content.
