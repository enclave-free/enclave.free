...
print(user_token("resume-rename-smoke-" + suffix + "@example.test", "Resume Rename Smoke"))
print(user_token("resume-rename-other-" + suffix + "@example.test", "Resume Rename Other"))
"""
    lines = [
        line.strip()
