...
def main() -> None:
    ...
    csrf_cookie_name = env_setting("CSRF_COOKIE_NAME", "enclave_csrf", backend_env_values, repo_env_values)
    admin_cookie_name = env_setting("ADMIN_SESSION_COOKIE_NAME", "enclave_admin_session", backend_env_values, repo_env_values)
