...
def run_docker_sql(sql: str, db_path: str = "/data/enclave.db", timeout: int = 30) -> str:
    """
...
def get_admin_pubkey_from_db(db_path: str = "/data/enclave.db") -> str | None:
...
def test_error_cases(api_base: str, admin_token: str, admin_pubkey: str, new_admin_pubkey: str, old_admin_privkey: str) -> bool:
    ...
    new_admin_privkey, _ = derive_keypair_from_seed("enclave-test-new-admin-keypair-v1")
